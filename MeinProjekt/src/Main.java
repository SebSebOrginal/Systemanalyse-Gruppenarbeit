...
public class Main {
    public static void main(String[] args) {
        VerwalteAccount verwalteAccount = new VerwalteAccount();

        //verwalteAccount.createAccount(verwalteAccount.getConnection());
        verwalteAccount.getData(verwalteAccount.getConnection());
        //verwalteAccount.createAccount(verwalteAccount.getConnection());
        //verwalteAccount.deleteAccount(verwalteAccount.getConnection());
        //verwalteAccount.updatePassword(verwalteAccount.getConnection());
        //verwalteAccount.updateUsername(verwalteAccount.getConnection());
